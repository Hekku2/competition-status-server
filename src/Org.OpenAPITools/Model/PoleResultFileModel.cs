...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PoleResultFileModel")]
    public partial class PoleResultFileModel : IEquatable<PoleResultFileModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoleResultFileModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PoleResultFileModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PoleResultFileModel" /> class.
        /// </summary>
        ...
        public PoleResultFileModel(double artisticScore = default(double), double executionScore = default(double), double difficultyScore = default(double), double headJudgePenalty = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoleResultFileModel {\n");
        ...
        {
            return this.Equals(input as PoleResultFileModel);
        }

        /// <summary>
        /// Returns true if PoleResultFileModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PoleResultFileModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoleResultFileModel input)
        {
            if (input == null)
            {
                return false;
