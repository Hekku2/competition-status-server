...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParticipationModel")]
    public partial class ParticipationModel : IEquatable<ParticipationModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ParticipationModel" /> class.
        /// </summary>
        /// <param name="division">Division name. Should match some division in currently active  competition (required).</param>
        ...
        public ParticipationModel(string division = default(string), int id = default(int), List<CompetitorModel> competitors = default(List<CompetitorModel>), PoleSportResultModel result = default(PoleSportResultModel), bool forfeit = default(bool))
        {
            // to ensure "division" is required (not null)
            if (division == null) {
                throw new ArgumentNullException("division is a required property for ParticipationModel and cannot be null");
            }
            this.Division = division;
            this.Id = id;
            // to ensure "competitors" is required (not null)
            if (competitors == null) {
                throw new ArgumentNullException("competitors is a required property for ParticipationModel and cannot be null");
            }
        ...
        /// <summary>
        /// Division name. Should match some division in currently active  competition
        /// </summary>
        /// <value>Division name. Should match some division in currently active  competition</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParticipationModel {\n");
        ...
        {
            return this.Equals(input as ParticipationModel);
        }

        /// <summary>
        /// Returns true if ParticipationModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ParticipationModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParticipationModel input)
        {
            if (input == null)
            {
                return false;
